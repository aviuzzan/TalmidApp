-- ============================================================================
-- Migration 2026-07-28 — RPC transactionnelle soumettre_contrat_famille
-- ----------------------------------------------------------------------------
-- Contexte (audit sécurité Fable 28/07) :
...
-- ============================================================================
-- ROLLBACK (à exécuter manuellement en cas de retour arrière — le front devra
-- être revenu à la version précédente AVANT, sinon la soumission sera cassée) :
--
-- DROP FUNCTION IF EXISTS public.soumettre_contrat_famille(uuid, uuid, text, jsonb, text, jsonb);
-- ============================================================================
