            ...
            {loading ? (
              ...
              <tr key={e.id} style={{ borderBottom: i < enfants.length - 1 ? '1px solid #F1F5F9' : 'none' }}>
                ...
                <td style={{ padding: '13px 16px' }}>
                  <button onClick={() => router.push(`/familles/${e.famille_id}`)}
                ...
                <td style={{ padding: '13px 16px' }}>
                  <button onClick={() => router.push(`/familles/${e.famille_id}`)} className="btn-secondary" style={{ padding: '5px 12px', fontSize: 12 }}>
                    Voir fiche →
                  </button>
                </td>
              </tr>
