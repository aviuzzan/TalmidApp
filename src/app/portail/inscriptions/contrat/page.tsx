  ...
  return (
    <div style={{ maxWidth: 700, margin: '0 auto', padding: '32px 24px', fontFamily: 'Inter, sans-serif', display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <Section title="1. Vos informations">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          <div><label style={lbl}>Prénom resp. 1 *</label><input style={inp} defaultValue={famForm.parent1_prenom || ''} onBlur={e => setFam('parent1_prenom', e.target.value)} /></div>
          <div><label style={lbl}>Nom resp. 1 *</label><input style={inp} defaultValue={famForm.parent1_nom || ''} onBlur={e => setFam('parent1_nom', e.target.value)} /></div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
            <div><label style={lbl}>CP *</label><input style={inp} defaultValue={famForm.parent1_code_postal || ''} onBlur={e => setFam('parent1_code_postal', e.target.value)} /></div>
          ...
          <div><label style={lbl}>Portable *</label><input style={inp} defaultValue={famForm.parent1_telephone || ''} onBlur={e => setFam('parent1_telephone', e.target.value)} /></div>
          ...
          {(famForm.parent2_prenom || famForm.parent2_nom) && <>
            <div><label style={lbl}>Prénom resp. 2</label><input style={inp} defaultValue={famForm.parent2_prenom || ''} onBlur={e => setFam('parent2_prenom', e.target.value)} /></div>
            <div><label style={lbl}>Nom resp. 2</label><input style={inp} defaultValue={famForm.parent2_nom || ''} onBlur={e => setFam('parent2_nom', e.target.value)} /></div>
            <div><label style={lbl}>Portable resp. 2</label><input style={inp} defaultValue={famForm.parent2_telephone || ''} onBlur={e => setFam('parent2_telephone', e.target.value)} /></div>
            <div><label style={lbl}>Email resp. 2</label><input style={inp} type="email" defaultValue={famForm.parent2_email || ''} onBlur={e => setFam('parent2_email', e.target.value)} /></div>
          </>}
        </div>
      </Section>
