...
function ContratsList({ ecoleId, ecoleSlug, annee }: { ecoleId: string; ecoleSlug: string; annee: string }) {
  ...
  async function validerContrat(id: string, _userId: string) {
    ...
    // 2. Génération de la facture via le helper UNIQUE lib/facture-contrat.ts
    //    (FIX audit 24/07/2026 pt 1 : ce code existait ici en double et avait
    //    divergé — la version dupliquée générait 1 ligne forfait globale en cas
