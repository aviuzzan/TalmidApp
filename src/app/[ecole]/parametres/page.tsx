...
type Tab = 'classes' | 'secteurs' | 'tarifs' | 'reductions_fn' | 'modes_reglement' | 'config_reduction' | 'config_paiement' | 'commission' | 'sepa'

export default function ParametresPage() {
  const ecole = useEcole()
  const searchParams = useSearchParams()
  const tabParam = searchParams.get('tab')
  const initTab = tabParam === 'inscriptions' ? 'secteurs' : tabParam === 'sepa' ? 'sepa' : 'classes'
