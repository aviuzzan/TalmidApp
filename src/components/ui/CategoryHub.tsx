...
const MODULES_PAR_CATEGORIE: Record<string, ModuleInfo[]> = {
  administration: [
    ...
    { code: 'administratif', nom: 'Historique / Archives', description: 'Familles archivées et élèves sortis, avec dates et motifs', icone: '🗄️', href: 'archives' },
  ...
  configuration: [
    ...
    { code: 'parametres', nom: 'Levy (assistant virtuel)', description: 'Activer Levy et éditer la FAQ qu\'il utilise pour répondre', icone: '👨‍🎓', href: 'parametres/chatbot' },
